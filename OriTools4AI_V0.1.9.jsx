...
//~Create_Window_and_Panel------------------------------------------
    var Script_Name  = "OriTools4AI", Script_Version = "_V0.1.9";
...
//~function_01------------------------------------------------------
    ...
    //DefineVariables
        ...
        //
        var blackStrokeLayers = ["D-14-DarkFace"];
    ...
    function Adjust_LayerOrder(){  
        ...
        document.layers.getByName('D-15-Page').visible = false;  
        app.redraw();
        } 
    //~~send Text to front
    ...
    function Object_to_Artboard(){
        ...
        var myLayer = document.layers.getByName('D-15-Page');  
